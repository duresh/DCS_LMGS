    ...
    <div class="box col-md-12">
        <div class="box-inner">
            <div class="box-header well" data-original-title="">
                ...
                <span class="label label-warning" style="font-size:13px"><a href="" style="color:white;text-decoration:none;">Pending</a></span>
                <span class="label label-primary" style="font-size:13px"><a href="" style="color:white;text-decoration:none;">Intermediate</a></span>
                <span class="label label-success" style="font-size:13px"><a href="" style="color:white;text-decoration:none;">Final</a></span>
                <span class="label label-default" style="font-size:13px"><a href="" style="color:white;text-decoration:none;">All</a></span>
                </h3>
